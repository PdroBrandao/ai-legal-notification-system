...
14. Qual o tipo de agendamento ("AUDIENCIA" | "PERICIA" | null )
...
Retorne APENAS o seguinte JSON:
{
  ...
  "tipo_agendamento": "AUDIENCIA" | "PERICIA" | null ,
...
6. Para identificar tipo de agendamento:
    ...
    - Sessões de julgamento devem ser consideradas como "AUDIENCIA"
    - Inclusão ou reinclusão em pauta sempre indica agendamento do tipo "AUDIENCIA"
    - Se houver menção a "Plenário", "Tribunal" ou "sustentação oral" junto com data/hora, considerar como "AUDIENCIA"
